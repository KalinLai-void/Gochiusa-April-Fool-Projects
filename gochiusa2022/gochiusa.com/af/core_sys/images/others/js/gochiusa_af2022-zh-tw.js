...
const tags = {
	...
	comics:'<div class="comics"><div class="comics__inner"><div class="comics__ph"><img src="core_sys/images/main/game/ed.png" ></div><div class="comics__dialogue"><ul><li class="comics__dialogue-elu"><div class="comics__dialogue-name">映月</div><div class="comics__dialogue-txt"></div></li><li class="comics__dialogue-natsume"><div class="comics__dialogue-name">夏明醬</div><div class="comics__dialogue-txt"></div></li></ul></div></div></div>',
...
const stageTxt = {
	...
	clear:{
		...
		'05':{
			...
			result:'帶回家中的並不是青鳥的蛋<br>※可以在麻耶確認心愛的樣子了',
		},
		'06':{
			name:'理世',
